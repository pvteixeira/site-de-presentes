...
export default function CoupleCards() {
  return (
    <section id="os-noivos" className="py-24 bg-[var(--color-wedding-beige)] dark:bg-[var(--color-wedding-beige)]/5">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="glass-card bg-white dark:bg-[var(--background)] p-8 md:p-10 flex flex-col items-center text-center border border-gray-100 dark:border-gray-800"
          >
            <span className="text-xs uppercase tracking-[0.2em] font-sans font-semibold text-[var(--color-wedding-gold)] px-4 py-1.5 rounded-full border border-[var(--color-wedding-gold)]/20 bg-[var(--color-wedding-gold)]/5 mb-6">
              Noiva
            </span>
            
            <h3 className="text-2xl md:text-3xl font-serif text-[var(--foreground)] mb-6">
              Aline Teixeira Bruno Silva
            </h3>
            
            <div className="w-12 h-[1px] bg-[var(--color-wedding-gold)]/30 mb-6"></div>
