    ...
    <main className="min-h-screen bg-[var(--background)] relative">
      ...
      <section id="historia" className="bg-[var(--background)] py-24 text-center px-4 border-t border-gray-200 dark:border-zinc-800">
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="space-y-6 md:space-y-7 max-w-2xl mx-auto text-base md:text-lg text-[var(--foreground)]/85 font-sans leading-relaxed md:leading-loose">
            ...
            <p className="text-justify text-justified-elegant indent-6 md:indent-8">
            ...
            <div className="pt-8 text-center space-y-1">
              <span className="font-serif text-xl italic font-medium block text-[var(--foreground)]">Com amor e carinho</span>
              <span className="font-signature text-3xl md:text-4xl block mt-2 font-normal text-[var(--foreground)]">Aline e Klécio</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="cortejo" className="py-20 bg-gray-50 dark:bg-zinc-900/60 border-t border-gray-200 dark:border-zinc-800">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="glass-card bg-white dark:bg-zinc-900 p-8 md:p-12 rounded-3xl border border-gray-200 dark:border-zinc-800 shadow-md flex flex-col items-center space-y-6">
            <div className="w-14 h-14 rounded-2xl bg-slate-200 dark:bg-zinc-800 text-slate-900 dark:text-slate-100 flex items-center justify-center shadow-sm border border-slate-300 dark:border-zinc-700">
              <Lock size={26} className="text-slate-700 dark:text-slate-300" />
            </div>
